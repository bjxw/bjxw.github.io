    ...
    render(){
        return(
            <div className={'esports-background'}>
                ...
                majored in computer science with hopes that I would eventually become a game developer.  My first competitive games were Super Smash Bros 64 and Pokemon where I fell in 
